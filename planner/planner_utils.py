...
def get_sh_initial_state():
    return {
        ...
        'motors':{
            'motor_0': 'initial_state',
            'motor_1': 'initial_state',
            'motor_2': 'initial_state',
            'motor_3': 'initial_state',
            'motor_4': 'initial_state',
            'motor_5': 'initial_state',
            'motor_6': 'initial_state',
            'motor_8': 'initial_state',
            'motor_9': 'initial_state',
            'motor_10': 'initial_state',
            'motor_11': 'initial_state',
            'motor_12': 'initial_state',
            'motor_13': 'initial_state',
            'motor_14': 'initial_state',
            'motor_15': 'initial_state'
        },
        'lamp': 'initial_state',
        'fan': 'initial_state',
        'ac': 'initial_state',
